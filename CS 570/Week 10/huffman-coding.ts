...
class BNode{
    ...
    left:BNode;
    right:BNode;
    constructor(data:LNode,left,right){
        this.data=data;
        this.left=left;
        this.right=right;
    }
...
class HuffmanTree{
    ...
    HuffmanCode(root:BNode,arr,top){
        if(root.left){
            arr[top]=0;
            top++;
